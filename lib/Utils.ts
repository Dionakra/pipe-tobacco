...
const shishaBrands: string[] = ["187", "Adalya", "Afendi", "Al-Waha", "Al Fakher", "Al Andalus", "Al Rayan", "Al Sultan Molasses", "Al Waha", "Al-Katar", "Almassiva", "Aloha", "Alrayan", "Alwazir", "AQM",
    ...
    "Camino", "Camel Vapeleaf Bolsa", "Sindbad Mint Water Pipe Tobacco", "Capìtal Bra Lecker Lecker", "Mayflower", "Tabacco Way - D'Ora", "Kaja", "Afzal", "Inferno Angel Vice", "Elixyr", "Inferno", "Sayes!"]
